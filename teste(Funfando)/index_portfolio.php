...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#portfolio"><?php echo "Portfolio"?></a></li>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-lg" id="color"  href="#portfolio" style="background-image: linear-gradient(to right top, #5000e9, #3b33f1, #244af6, #085df8, #006df9);"><?php echo"Tell Me More"?> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="28" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
 ...
 <section class="page-section bg-light" id="portfolio">
    <div class="container">
        ...
        <h2 class="section-heading text-uppercase"><?php echo "Portfolio"?></h2>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                ...
                <div class="portfolio-item">
                    <a class="portfolio-link" data-bs-toggle="modal" href="">
                        ...
                        <img class="img-fluid" src="assets/img/portfolio/1.webp" alt="..." />
                    </a>
                    <div class="portfolio-caption">
                        <div class="portfolio-caption-heading"><?php echo "Lorem ipsum dolor sit amet consectetur."?></div>
                        <div class="portfolio-caption-subheading text-muted"><?php echo "Lorem ipsum dolor sit amet consectetur."?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mb-4">
