    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-lg" id="color"  href="#team" style="background-image: linear-gradient(to right top, #5000e9, #3b33f1, #244af6, #085df8, #006df9);">Tell Me More <svg xmlns="http://www.w3.org/2000/svg" width="30" height="28" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
